...
features: # 可选的
  - title: 前端
    ...
    link: /web/ # 可选
    imgUrl: https://xavierpic.oss-cn-hangzhou.aliyuncs.com/img/1.png # 可选
  - title: 技术
    details: 技术文档、教程、技巧、总结等文章
    link: /technology/
    imgUrl: https://xavierpic.oss-cn-hangzhou.aliyuncs.com/img/4.png
  - title: 面试
    details: 题目及答案总结等
    link: /interview/
    imgUrl: https://xavierpic.oss-cn-hangzhou.aliyuncs.com/img/3.png
